...
# taken from https://github.com/vllm-project/vllm/blob/main/benchmarks/benchmark_throughput.py
...
def main(args: argparse.Namespace):
    ...
    if args.backend == "vllm":
        elapsed_time, responses = run_vllm(requests, args.model, args.tokenizer,
    ...
    total_num_tokens = sum([
        len(tokenizer.encode(output.text)) 
