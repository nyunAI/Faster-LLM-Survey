# taken from https://github.com/PanQiWei/AutoGPTQ/blob/main/examples/benchmark/generation_speed.py
# This script benchmarks the generation speed of GPTQ with Alpaca dataset.
import json
import time
import logging
import random
...
def main():
    ...
    parser.add_argument("--dataset", type=str, default=None, help="path to alpaca dataset (.json)")
    ...
    examples = load_data(args.dataset, tokenizer, args.num_samples, args.max_new_tokens)
