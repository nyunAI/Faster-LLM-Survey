# taken from https://github.com/PanQiWei/AutoGPTQ/tree/main/examples/quantization
# This script implements GPTQ quantization through AutoGPTQ with Alpaca dataset.
...
def main():
    ...
    examples = load_data(args.dataset, tokenizer, args.num_samples)
    examples_for_quant = [
